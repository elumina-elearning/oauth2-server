...
use EluminaElearning\Event\Emitter;
use EluminaElearning\OAuth2\Server\Storage\AccessTokenInterface;
use EluminaElearning\OAuth2\Server\Storage\AuthCodeInterface;
use EluminaElearning\OAuth2\Server\Storage\ClientInterface;
use EluminaElearning\OAuth2\Server\Storage\MacTokenInterface;
...
use EluminaElearning\OAuth2\Server\TokenType\TokenTypeInterface;
...
abstract class AbstractServer
{
     ...
     * Session storage
     *
     * @var \EluminaElearning\OAuth2\Server\Storage\SessionInterface
     */
     ...
     *
     * @var \EluminaElearning\OAuth2\Server\Storage\AccessTokenInterface
     */
     ...
     *
     * @var \EluminaElearning\OAuth2\Server\Storage\RefreshTokenInterface
     */
     ...
     * Auth code storage
     *
     * @var \EluminaElearning\OAuth2\Server\Storage\AuthCodeInterface
     */
     ...
     * Scope storage
     *
     * @var \EluminaElearning\OAuth2\Server\Storage\ScopeInterface
     */
     ...
     * Client storage
     *
     * @var \EluminaElearning\OAuth2\Server\Storage\ClientInterface
     */
    protected $clientStorage;

    /**
     * @var \EluminaElearning\OAuth2\Server\Storage\MacTokenInterface
     */
     ...
     * Token type
     *
     * @var \EluminaElearning\OAuth2\Server\TokenType\TokenTypeInterface
     */
    protected $tokenType;
     ...
     * Event emitter
     *
     * @var \EluminaElearning\Event\Emitter
     */
     ...
     *
     * @return \EluminaElearning\Event\Emitter
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Storage\ClientInterface $storage
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Storage\SessionInterface $storage
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Storage\AccessTokenInterface $storage
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Storage\RefreshTokenInterface $storage
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Storage\AuthCodeInterface $storage
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Storage\ScopeInterface $storage
     *
     * @return self
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Storage\ClientInterface
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Storage\ScopeInterface
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Storage\SessionInterface
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Storage\RefreshTokenInterface
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Storage\AccessTokenInterface
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Storage\AuthCodeInterface
     */
