...
use EluminaElearning\OAuth2\Server\Event\SessionOwnerEvent;
...
class SessionEntity
{
     ...
     * Client identifier
     *
     * @var \EluminaElearning\OAuth2\Server\Entity\ClientEntity
     */
    protected $client;
     ...
     * Auth code
     *
     * @var \EluminaElearning\OAuth2\Server\Entity\AuthCodeEntity
     */
    protected $authCode;
     ...
     * Refresh token
     *
     * @var \EluminaElearning\OAuth2\Server\Entity\RefreshTokenEntity
     */
     ...
     *
     * @var \EluminaElearning\OAuth2\Server\AuthorizationServer|\EluminaElearning\OAuth2\Server\ResourceServer
     */
    protected $server;
     ...
     * Associate a scope
     *
     * @param \EluminaElearning\OAuth2\Server\Entity\ScopeEntity $scope
     *
     * @return self
     */
     ...
     *
     * @param  \EluminaElearning\OAuth2\Server\Entity\Scope[]
     *
     * @return array
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Entity\AccessTokenEntity $accessToken
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Entity\RefreshTokenEntity $refreshToken
     *
     * @return self
     */
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\Entity\ClientEntity $client The client
     *
     * @return self
     */
     ...
     *
     * @return \EluminaElearning\OAuth2\Server\Entity\ClientEntity
     */
