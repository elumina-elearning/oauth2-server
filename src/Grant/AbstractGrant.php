...
use EluminaElearning\OAuth2\Server\Entity\ClientEntity;
use EluminaElearning\OAuth2\Server\Entity\ScopeEntity;
use EluminaElearning\OAuth2\Server\Exception;
...
abstract class AbstractGrant implements GrantTypeInterface
{
     ...
     * AuthServer instance
     *
     * @var \EluminaElearning\OAuth2\Server\AuthorizationServer
     */
    protected $server;
     ...
     * @param \EluminaElearning\OAuth2\Server\Entity\ClientEntity $client      Client entity
     ...
     *
     * @throws \EluminaElearning\OAuth2\Server\Exception\InvalidScopeException If scope is invalid, or no scopes passed when required
     * @throws
     */
     ...
     *
     * @param  \EluminaElearning\OAuth2\Server\Entity\ScopeEntity[]
     *
     * @return array
     */
