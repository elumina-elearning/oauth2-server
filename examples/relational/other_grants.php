...
$server = new \EluminaElearning\OAuth2\Server\AuthorizationServer();
...
$clientCredentials = new \EluminaElearning\OAuth2\Server\Grant\ClientCredentialsGrant();
$server->addGrantType($clientCredentials);

$passwordGrant = new \EluminaElearning\OAuth2\Server\Grant\PasswordGrant();
...
$refrehTokenGrant = new \EluminaElearning\OAuth2\Server\Grant\RefreshTokenGrant();
...
} catch (\EluminaElearning\OAuth2\Server\Exception\OAuthException $e) {
